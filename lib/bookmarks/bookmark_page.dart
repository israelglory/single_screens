...
import 'package:single_screens/bookmarks/bottom_modal_sheet.dart';
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            onRemoveBookmarkDialog(
                              context: context,
                              onYesPressed: () {},
                              onCancelPressed: () {},
                            );
                          },
                          child: const BookmarkItem(
                            images: [
